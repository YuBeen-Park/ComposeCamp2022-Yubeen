...
fun DogItem(dog: Dog, modifier: Modifier = Modifier) {
    ...
    val color by animateColorAsState(targetValue = if(expanded) MaterialTheme.colors.secondary else MaterialTheme.colors.surface)
    Card(
        elevation = 4.dp,
        ...
        Column(
            ...
            Row(
                ...
                Spacer(Modifier.weight(1f)) // 스페이서는 행에서 가중치가 적용된 유일한 하위 요소이므로 남아 있는 공간을 채운다.
